...
activities = {
    ...
    "Soccer Team": {
        "description": "Train for school soccer matches and practice teamwork",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "nina@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice basketball skills and friendly games",
        "schedule": "Wednesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["leo@mergington.edu", "maya@mergington.edu"]
    },
    "Drama Club": {
        "description": "Explore acting, stagecraft, and school productions",
        "schedule": "Mondays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["sara@mergington.edu", "ethan@mergington.edu"]
    },
    "Art Workshop": {
        "description": "Create paintings, sculptures, and mixed-media art",
